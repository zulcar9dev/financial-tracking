    ...
    <div className="page-stack">
      <section className="page-heading">
        ...
        <div className="heading-actions">
          <Link className="page-button ghost" href="/app/dashboard"><span>↩</span> Dashboard</Link>
        </div>
      </section>
      ...
      <section className="account-grid">
        ...
        <a className="add-account" href="#new-account">
          <div><span>＋</span><strong>Tambah akun baru</strong><small>Bank, tunai, dompet digital, atau kartu kredit</small></div>
        </a>
      </section>
